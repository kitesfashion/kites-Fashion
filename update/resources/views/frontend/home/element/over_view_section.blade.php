@php
  use App\Menu;
  $menuDetails = Menu::where('id',2)->first();
@endphp
<section id="portfolio">
  <div class="grid products">
    <div class="grid-item grid-item-width2"> 
      <img src="{{ asset('public/frontend/') }}/assets/images/1.jpg">
      <div class="data-box">
        <div class="heading-pattern text-center">
          <h3>{{$overViewSection->firstHomeTitle}}</h3>
          <div class="heading-bottom"></div>
        </div>
        <div class="description" style="margin-top: -19px">
          @php
            echo $overViewSection->homeDescription;
          @endphp
        </div>
      </div>
    </div>
