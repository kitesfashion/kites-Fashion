...
<?php
    use App\Article;
?>
<form class="form-horizontal" action="{{ route('collectionCategory.add') }}" method="POST" enctype="multipart/form-data">
    {{ csrf_field() }}
    ...
    <div class="modal-body">
        ...
        <div class="form-group row {{ $errors->has('articleName') ? ' has-danger' : '' }}">
            ...
            <div class="col-sm-9">
                <input type="text" class="form-control form-control-danger" placeholder="category name" name="articleName" value="{{ old('articleName') }}">
