...
<?php
    use App\Article;
?>
<form class="form-horizontal" action="{{ route('collectionCategory.edit',$articles->id) }}" method="POST" enctype="multipart/form-data" name="form">
    {{ csrf_field() }}
    ...
    <div class="modal-body">
        ...
        <div class="form-group row {{ $errors->has('articleName') ? ' has-danger' : '' }}">
            ...
            <div class="col-sm-9">
                <input type="text" class="form-control form-control-danger" placeholder="category name" name="articleName" value="{{ $articles->articleName }}">
        ...
        <div class="form-group row {{ $errors->has('firstHomeImage') ? ' has-danger' : '' }}">
            ...
            <div class="col-sm-9">
                ...
                <span class="imageSizeInfo">
                    /*  Min Width: 455px, Min Height: 500px 
                    /*
                </span><br>
        ...
        <div class="form-group row {{ $errors->has('firstInnerImage') ? ' has-danger' : '' }}">
            ...
            <div class="col-sm-9">
                ...
                <span class="imageSizeInfo">
                    /*  Min Width: 960px, Min Height: 610px 
                    /*
                </span><br>
        ...
        <div class="form-group row {{ $errors->has('headerImage') ? ' has-danger' : '' }}">
            ...
            <div class="col-sm-9">
                ...
                <?php if (file_exists(@$articles->headerImage)) { ?> 
                <img src="{{asset('/').@$articles->headerImage}}" style="height: 90px;">
                <?php }else{ ?>
                    <img src="{{asset('/public/frontend/noImage.jpg')}}" style="height: 94px;">
                <?php } ?>
