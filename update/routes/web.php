...
Route::prefix('admin')->group(function()
{
	...
	Route::group(['middleware'=>'menuPermission'],function(){
		...
		Route::get('/collection-category', 'Admin\CollectionCategoryController@index')->name('collectionCategory.index');
		Route::match(['GET', 'POST'], '/collection-category/add', 'Admin\CollectionCategoryController@add')->name('collectionCategory.add');
		Route::match(['GET', 'POST'], '/collection-category/edit/{id}', 'Admin\CollectionCategoryController@edit')->name('collectionCategory.edit');
		Route::get('/collection-category/status/{id}', 'Admin\CollectionCategoryController@status')->name('collectionCategory.status');
		Route::match(['GET', 'POST'], '/collection-category/delete/{id}', 'Admin\CollectionCategoryController@delete')->name('collectionCategory.delete');

		Route::post('/get-sub-article', 'Admin\CollectionCategoryController@getSubArticle')->name('getSubArticle');
	   ...
	   Route::match(['GET', 'POST'], '/client/add', 'Admin\ClientController@add')->name('client.add');
	   Route::match(['GET', 'POST'], '/client/edit/{id}', 'Admin\ClientController@edit')->name('client.edit');
	   Route::get('/client/status/{id}', 'Admin\ClientController@status')->name('client.status');
...
/*Url for menu*/
Route::get('/get-category-product/{categoryId}/{itemPerPage}', 'CollectionController@GetCategoryProduct')->name('getCategoryProduct');
//News letter subscribe section here
...
Route::get('/{parenProduct}/{product}/{id}', 'ProductController@Details')->name('product.details');
Route::get('/{parenMenu}/{submenu}/product/{articleId}', 'CollectionController@Details')->name('collection.details');

Route::get('/blog/{id}', 'BlogController@BlogDetails')->name('blog.details');

Route::get('/team/all-member', 'TeamController@AllMember')->name('team.allTeamMember');

Route::get('/client/{id}', 'TeamController@client')->name('client.client');
