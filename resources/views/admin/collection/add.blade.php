...
<form class="form-horizontal" action="{{ route('collection.add') }}" method="POST" enctype="multipart/form-data">
    ...
    <div class="modal-body">
        <div class="form-group row {{ $errors->has('parentArticle') ? ' has-danger' : '' }}">
            <label for="inputHorizontalDnger" class="col-sm-3 col-form-label">Category</label>
            <div class="col-sm-9">
                <select class="form-control chosen-select mainArticle" name="parentArticle" required>
