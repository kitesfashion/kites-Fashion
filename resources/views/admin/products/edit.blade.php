...
@section('content')
<form class="form-horizontal" action="{{ route('products.edit',$articles->id) }}" method="POST" enctype="multipart/form-data" name="form">
    {{ csrf_field() }}
        ...
        <div class="form-group row {{ $errors->has('firstHomeImage') ? ' has-danger' : '' }}">
            ...
            <div class="col-sm-9">
                ...
                <span class="imageSizeInfo">
                    /* Here Image minimum size according to product order <br>
