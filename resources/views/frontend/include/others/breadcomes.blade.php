...
@if(@$menuDetails->id == 1)
  <section class="banner haslayout parallax-window" style="background-image:url('{{asset('/').@$about->headerImage}}" {{-- data-img-width="2000" data-img-height="400" --}} data-diff="100">
  </section>
@elseif(@$subMenuList)
  <span id="collectionHeaderImage"></span>
@endif
